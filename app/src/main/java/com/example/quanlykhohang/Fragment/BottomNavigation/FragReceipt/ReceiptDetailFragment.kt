...
import com.example.quanlykhohang.databinding.FragmentReceiptDetailBinding
...
class ReceiptDetailFragment : Fragment() {
    ...
    private lateinit var adapter: ReceiptBillDetailAdapter
    ...
    override fun onCreateView(
        ...
        binding = FragmentReceiptDetailBinding.bind(view)
    ...
    private fun loadData() {
        ...
        adapter = ReceiptBillDetailAdapter(listBillDetail, requireContext())
